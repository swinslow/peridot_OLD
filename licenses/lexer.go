...
// The portions of this file that are original to The Linux Foundation are
// licensed under the Apache License, version 2.0.

// This file uses the lexmachine dependency, and some portions of this file
// are derived from the lexmachine "sensors" example.
// lexmachine is under the BSD-3-Clause license with the following
